...
import { UserLoginDto, UserCreateDto, LoginResponse, UserResponseDto, UserRole } from '../types/auth';
...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
    ...
    const login = async (credentials: UserLoginDto): Promise<LoginResponse | null> => {
        try {
            setLoading(true);
            setError(null);
    ...
    const register = async (userData: UserCreateDto): Promise<LoginResponse | null> => {
        try {
            setLoading(true);
            setError(null);
