  ...
  return (
    <div className="lg:min-w-[60vw] mx-auto my-12  dark:bg-dark dark:border dark:border-white/30 rounded p-5">
      ...
      {stats.programmes.map((programme, index) => (
        <Card key={index} className="mb-6 p-6 border border-muted  dark:bg-dark dark:border dark:border-white/30 rounded ">
          ...
          <p className="text-primary">Match Rate: {programme.matchRate.toFixed(2)}%</p>
